...
alma.x: alma.o tommyarray.o tommyhashlin.o tommyhash.o tommylist.o mpc.o alma_parser.o alma_formula.o alma_kb.o alma_unify.o
	$(CC) alma.o tommyarray.o tommyhashlin.o tommyhash.o tommylist.o mpc.o alma_parser.o alma_formula.o alma_kb.o alma_unify.o -o alma.x

alma.o: alma.c alma_parser.h alma_formula.h alma_unify.h
	$(CC) $(CFLAGS) -c alma.c
...
alma_formula.o: alma_formula.c mpc/mpc.h alma_parser.h alma_formula.h
	$(CC) $(CFLAGS) -c alma_formula.c

alma_kb.o: alma_kb.c alma_unify.h alma_formula.h alma_kb.h $(TOMMY)tommytypes.h $(TOMMY)tommyarray.h $(TOMMY)tommyhashlin.h $(TOMMY)tommyhash.h
