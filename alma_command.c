...
void kb_init(kb **collection, char **files, int file_count, char *agent, char *trialnum, char *log_dir,  int verbose, kb_str *buf, int logon) {
  ...
  *collection = malloc(sizeof(**collection));
  ...
  const alma_proc procs[13] = {{"neg_int", 1}, {"neg_int_spec", 1}, {"neg_int_gen", 1}, {"pos_int", 1}, {"pos_int_spec", 1},
                   {"pos_int_gen", 1}, {"acquired", 2}, {"ancestor", 3}, {"non_ancestor", 3}, {"parent", 3}, {"less_than", 2},
                   {"quote_cons", 2}, {"not_equal", 2}};
