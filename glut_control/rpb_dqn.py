...
class rpb_dqn(res_prebuffer):
    ...
    def model_save(self, id_str):
        ...
        pickle.dump((self.subjects, self.words, self.num_subjects, self.num_words,
                     ...
                     self.batch_size, self.max_gnn_nodes, self.max_reward), pkl_file)
        self.current_model.model.save("rpb_dqn_current_model_{}".format(id_str))
        self.target_model.model.save("rpb_dqn_target_model_{}".format(id_str))
    ...
    def model_load(self, id_str):
        ...
        self.current_model.model = keras.models.load_model("rpb_dqn_current_model_{}".format(id_str))
        self.target_model.model = keras.models.load_model("rpb_dqn_target_model_{}".format(id_str))
