...
def produce_graphs():
    ...
    for condition in [False, True]:
        for threshold in [1.0, 0.25]:
            ...
            fname = "hw_data_{}_{}.pkl".format(condition, threshold)
            ...
            ax.plot(D)
            ax.legend()
            plt.savefig("hw_img_d_{}_{}.png".format(condition, threshold), bbox_inches='tight')
